...
import logo from '../../_img/filmbuff 1.png';
import logoKanji from '../../_img/filmbuff 2.png';
    ...
    return (
      <div className="App-header">
        <div className="App-logo">
          <a className="App-header-title" href="/"><img src={logo} alt="FilmBuff"/></a>
          <a className="App-header-title-kanji" href="/"><img src={logoKanji} alt="FilmBuff 2"/></a>
        </div>
        <SearchBar />
